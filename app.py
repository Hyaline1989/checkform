...
MANAGERS_LIST = [
    'Аксюбина Ангелина', 'Аладьина Алина', 'Волков Алексей',
    'Гурмекова Алина', 'Долгий Олеся', 'Елюбаев Рустам',
    'Жирякова Оксана', 'Конаныхина Татьяна', 'Лазарева Полина',
    'Лосев Николай', 'Мандрик Асель', 'Мельник Полина',
    'Мищенко Дарья', 'Полякова Надежда', 'Прохина Алёна',
    'Талерчик Вячеслав', 'Фролова Диана', 'Ходневич София',
    'Чупрунова Ирина'
]
